  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
         Fix Health <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Fix Health, your trusted online Healthcare platform. Our
          mission is to provide accessible and personalized Fix Healthcare
        ...
        <p className="legal-description">
          When using Fix Health, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Fix Health is designed to simplify Healthcare access. You can choose a
